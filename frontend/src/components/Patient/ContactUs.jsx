...
function ContactUs() {
  ...
  return (
    <section className="h-screen w-screen bg-[#FFFFFF]">
      <Navbar />
      <motion.div
        ref={ref}
        initial={{ opacity: 0 }}
        ...
        <div className="flex flex-wrap gap-10 mx-4 md:mx-14 py-14">
          <div className="flex-col hidden md:flex">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-zinc-500 text-base">feedback@ehm.org</span>
            </div>
          </div>
          <motion.div
            ref={ref}
          ...
          >
            ...
            <button
              ...
              type="button"
              className="rounded-md bg-[#8febbf] px-10 py-3 text-lg font-semibold text-white shadow-sm hover:scale-105 duration-150 active:scale-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
            >
              Submit
            </button>
          </motion.div>
