                ...
                <div>
                  <div className="flex justify-start  gap-2 items-center ">
                    ...
                    <p className="text-xl font-semibold">
                      Trusted E-Health Systems
                    </p>
                  </div>
                  <p className="text-sm">
                    Great e-health monitoring systems demonstrate
                    professionalism through ethical data handling, reliability,
        ...
        <div className=" max-w-7xl m-auto flex flex-col justify-center gap-8 items-center w-full h-full overflow-auto ">
          ...
          >
            ...
            <p className="text-sm text-center">
              An e-health monitoring system is a digital healthcare solution
              that provides patient care through advanced technology and
            ...
            <div className="flex flex-col items-start py-5 p-5 w-[450px] shadow-2xl bg-[#d1ffe9] rounded-lg">
              <div className="flex justify-center items-center">
                ...
                <div className="flex flex-col justify-center items-center ps-3">
                  <p className="font-semibold">Ms. Luna Bliss</p>
                  <div className="flex ">
                    <svg
                      className="size-5"
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div>
                <p className="">
                  I've tried many e-health monitoring systems, but EHMS is truly
                  one of the best out there.{" "}
                </p>
                <p>
                  From the seamless user experience to accurate real-time health
                  tracking, everything has been top-notch. The support team has
                  also been incredibly helpful and responsive.
                </p>
                <p>
                  {" "}
                  I highly recommend EHMS to anyone looking for a reliable
                  health monitoring solution. Thanks again for all your help!
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="w-full md:w-2/3 lg:w-1/2">
                ...
                <p className="mt-4 text-gray-600">
                  ...
                  E-health Monitoring System to stay updated about the
                  developments in healthcare field.
                </p>
                <div className="mt-4">
